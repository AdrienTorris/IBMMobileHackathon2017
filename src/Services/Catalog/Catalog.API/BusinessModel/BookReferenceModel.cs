namespace IBM.Books.Catalog.API.BusinessModel
{
    ...
    /// </summary>
    public class BookReferenceModel
    {
        /// <summary>
        ...
        /// </summary>
        public BookReferenceSources Source { get; set; }
        ...
        /// <summary>
        /// Liste des identifiants des auteurs
        /// </summary>
        public IList<int> AuthorIds { get; set; }

        public IEnumerable<BookItemModel> BookItems { get; set; }
