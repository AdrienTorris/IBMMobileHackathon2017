...
namespace Catalog.API.Infrastructure.CatalogContextMigrations
{
    ...
    [Migration("20171006112214_AddNormlizationOnEntities")]
    partial class AddNormlizationOnEntities
    {
            ...
            modelBuilder.Entity("IBM.Books.Catalog.API.Model.Author", b =>
                {
                    ...
                    b.Property<DateTime>("InsertedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 10, 6, 13, 22, 14, 799, DateTimeKind.Local));
            ...
            modelBuilder.Entity("IBM.Books.Catalog.API.Model.BookItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 10, 6, 13, 22, 14, 796, DateTimeKind.Local));
            ...
            modelBuilder.Entity("IBM.Books.Catalog.API.Model.BookReference", b =>
                {
                    ...
                    b.Property<DateTime>("InsertedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 10, 6, 13, 22, 14, 788, DateTimeKind.Local));
                    ...
                    b.Property<DateTime>("LastUpdatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasDefaultValue(new DateTime(2017, 10, 6, 13, 22, 14, 791, DateTimeKind.Local));
            ...
            modelBuilder.Entity("IBM.Books.Catalog.API.Model.Publisher", b =>
                {
                    ...
                    b.Property<DateTime>("InsertedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 10, 6, 13, 22, 14, 802, DateTimeKind.Local));
