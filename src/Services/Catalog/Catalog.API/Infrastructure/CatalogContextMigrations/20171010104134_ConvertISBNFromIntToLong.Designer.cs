...
namespace Catalog.API.Infrastructure.CatalogContextMigrations
{
    ...
    [Migration("20171010104134_ConvertISBNFromIntToLong")]
    partial class ConvertISBNFromIntToLong
    {
            ...
            modelBuilder.Entity("IBM.Books.Catalog.API.Model.Author", b =>
                {
                    ...
                    b.Property<DateTime>("InsertedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 10, 10, 12, 41, 34, 652, DateTimeKind.Local));
            ...
            modelBuilder.Entity("IBM.Books.Catalog.API.Model.BookItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 10, 10, 12, 41, 34, 649, DateTimeKind.Local));
            ...
            modelBuilder.Entity("IBM.Books.Catalog.API.Model.BookReference", b =>
                {
                    ...
                    b.Property<DateTime>("InsertedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 10, 10, 12, 41, 34, 641, DateTimeKind.Local));
                    ...
                    b.Property<DateTime>("LastUpdatedDate")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasDefaultValue(new DateTime(2017, 10, 10, 12, 41, 34, 644, DateTimeKind.Local));
            ...
            modelBuilder.Entity("IBM.Books.Catalog.API.Model.Publisher", b =>
                {
                    ...
                    b.Property<DateTime>("InsertedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 10, 10, 12, 41, 34, 655, DateTimeKind.Local));
